...
export function BuildingPermitTable({ items, onEdit, onDelete, deleteId, setDeleteId, page, totalPages, onPageChange }: Props) {
  if (items.length === 0) {
    return (
      <Card className="bg-white border border-gray-200 rounded-xl">
        <CardContent className="p-16 text-center">
          ...
          <p className="text-sm text-gray-500">Add a workflow step, doc category, regulation, or municipality to get started.</p>
        </CardContent>
      </Card>
    );
  }
