    ...
    if (isSvgUrl(preview)) {
      return (
        <div className="relative max-w-[90vw] max-h-[90vh] w-full h-full" onClick={(e) => e.stopPropagation()}>
          <img src={preview} alt="Full preview" className="w-full h-full object-contain rounded-lg" />
        </div>
      );
    }
    return (
                  ...
                  {editing?.url && files.length === 0 && (
                    <div className="mb-3 space-y-2">
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <div className="size-14 rounded-lg overflow-hidden bg-gray-100 border border-gray-200 shrink-0 flex items-center justify-center relative">
                          {isSvgUrl(editing.url) ? (
                            ...
                            <Image src={editing.url} alt={editing.alt} fill className="object-cover" sizes="56px" />
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <div className="size-14 rounded-lg overflow-hidden bg-gray-100 border border-gray-200 shrink-0 flex items-center justify-center relative">
                          {files[0].type === "image/svg+xml" ? (
                            ...
                            <Image src={preview} alt="Preview" fill className="object-cover" sizes="56px" />
