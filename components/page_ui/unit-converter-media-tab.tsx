...
interface UnitConverterMediaTabProps {
...
export function UnitConverterMediaTab({
  bannerImages,
  videoUrl,
  onBannerImagesChange,
  onChange,
}: UnitConverterMediaTabProps) {
      ...
      <div className="p-5 bg-white border border-gray-200 rounded-xl">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="text-xs"
          />
          <p className="text-xs text-gray-400">External video URL for this conversion.</p>
        </div>
        {videoUrl && (
