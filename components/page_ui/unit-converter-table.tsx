...
export function UnitConverterTable({ items, onEdit, onDelete, deleteId, setDeleteId, page, totalPages, onPageChange }: Props) {
  if (items.length === 0) {
    return (
      <Card className="bg-white border border-gray-200 rounded-xl">
        <CardContent className="p-16 text-center">
          ...
          <p className="text-sm font-medium text-gray-900 mb-1">No conversions yet</p>
          <p className="text-sm text-gray-500">Create a unit conversion rule to get started.</p>
        </CardContent>
      </Card>
    );
  }
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-gray-200 hover:bg-transparent">
              ...
              <TableHead className="text-gray-900 font-semibold">Base Unit</TableHead>
              <TableHead className="text-gray-900 font-semibold">Conversions</TableHead>
          ...
          <TableBody>
            {items.map((item) => (
              ...
              >
                ...
                <TableCell>
                  <span className="text-sm text-gray-600">{item.conversions.length} rules</span>
                </TableCell>
                <TableCell>
                  <Badge
                    variant="outline"
