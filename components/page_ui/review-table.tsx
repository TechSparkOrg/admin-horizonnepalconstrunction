...
export function ReviewTable({ groups, onEdit, onDelete, deleteId, setDeleteId, page, totalPages, onPageChange }: Props) {
  if (groups.length === 0) {
    return (
      <Card className="bg-white border border-gray-200 rounded-xl">
        <CardContent className="p-16 text-center">
          ...
          <p className="text-sm text-gray-500">Create your first review group to get started.</p>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <>
      ...
      <DeleteDialog
        ...
        title="Delete review group?"
        description="This will also remove all reviews inside it."
      />
    </>
  );
}
