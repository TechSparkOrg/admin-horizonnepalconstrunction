...
export function PrivateDocumentTable({ items, onEdit, onDelete, deleteId, setDeleteId, page, totalPages, onPageChange }: Props) {
  if (items.length === 0) {
    return (
      <Card className="bg-white border border-gray-200 rounded-xl">
        <CardContent className="p-16 text-center">
          ...
          <p className="text-sm text-gray-500">Create a document to get started.</p>
        </CardContent>
      </Card>
    );
  }
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-gray-200 hover:bg-transparent">
              ...
              <TableHead className="text-gray-900 font-semibold">Documents</TableHead>
              <TableHead className="text-gray-900 font-semibold">Proposals</TableHead>
