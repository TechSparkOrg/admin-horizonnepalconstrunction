...
const PrivateDocumentForm = dynamic(() => import("@/components/page_ui/private-document-form").then((m) => m.PrivateDocumentForm), { ssr: false });
const EMPTY_FORM: PrivateDocumentFormData = { title: "", slug: "", project_id: "", documents: [], proposals: [], status: "active", contract_closed: false, date: "" };
